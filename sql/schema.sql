...
CREATE TABLE IF NOT EXISTS players (
  ...
  avatar TEXT, -- aceita URL de imagem OU uma data URI base64 (ex: "data:image/jpeg;base64,...")
...
-- Histórico de partidas já encerradas (fica guardado mesmo depois que a
-- sala em si não é mais usada).
